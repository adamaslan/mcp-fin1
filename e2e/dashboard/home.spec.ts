...
test.describe("Dashboard - Home Page", () => {
  test("dashboard loads for authenticated free user", async ({
    authenticatedPage,
  }) => {
  ...
  test("dashboard displays all quick action cards", async ({
    authenticatedPage,
  }) => {
    const dashboard = new DashboardPage(authenticatedPage);
    await dashboard.goto();
  ...
  test("quick action card links navigate correctly", async ({
    authenticatedPage,
  }) => {
    const dashboard = new DashboardPage(authenticatedPage);
    await dashboard.goto();
...
test.describe("Dashboard - Sidebar Navigation", () => {
  ...
  test("free tier sees accessible features unlocked", async ({
    authenticatedPage,
  }) => {
    const sidebar = new Sidebar(authenticatedPage);
    await authenticatedPage.goto("/dashboard");
