...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    icon: ShieldAlert,
    tier: "pro",
    headline: "Know your exact max-loss exposure before the market moves",
    description:
      "Assess aggregate risk across all your positions using ATR-based volatility stops. See total max-loss in dollars, sector concentration, and risk quality per position — so you know exactly what's at stake if every stop gets hit.",
    highlights: [
      "ATR-based stop level per position",
      "Total max-loss if all stops hit today",
      "Sector concentration breakdown",
      "Risk quality scoring: Tight / Moderate / Wide",
    ],
    stat: "4.2%",
    statLabel: "Typical Portfolio Risk %",
  },
  {
    id: "morning_brief",
    name: "Morning Brief",
